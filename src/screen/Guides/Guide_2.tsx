...
import {logo, guideAudio} from '../../images';
...
export default function Guide_2({navigation}) {
  ...
  return (
    <IntroSection>
      ...
      <ImageWrap height={height}>
        <GuideAudio source={guideAudio} />
      </ImageWrap>
      <BtnWrap height={height}>
        <NextBtn onPress={() => navigation.navigate('Guide3')} height={height}>
          <BtnText>계속</BtnText>
        </NextBtn>
      </BtnWrap>
    </IntroSection>
